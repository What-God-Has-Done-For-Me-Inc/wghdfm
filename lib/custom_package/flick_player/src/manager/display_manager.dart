...
class FlickDisplayManager extends ChangeNotifier {
  ...
  Timer? _showQualityControlsTimer;
  ...
  bool _showQualityControls = false;
  bool _showQualityButton = false;
  double? volume;
  ...
  bool get showQualityControls => _showQualityControls;
  bool get showQualityButton => _showQualityButton;
  ...
  ///User Quality tap action.
  handeleQualityTap() {
    if (_showQualityControls) {
      _showQualityControls = false;
      _showQualityControlsTimer?.cancel();
      _notify();
    } else {
      _showQualityControls = true;
      _notify();
    }
  }

  handelQualityButton({required bool show}) {
    _showQualityButton = show;
    _notify();
  }
