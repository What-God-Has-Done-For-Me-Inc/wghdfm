...
//   // final locationPermission = location.Location();
...
//   print(" Permission of Location >> ${await Permission.camera.status}");
//   print(" Permission of bluetoothScan >> ${await Permission.microphone.status}");
//   // showLog(" Permission of bluetoothConnect >> ${await Permission.bluetoothConnect.status}");
//   ///For Location..
//   if ((await Permission.camera.status != PermissionStatus.granted || await Permission.microphone.status != PermissionStatus.granted) == true) {
//     await Get.dialog(CupertinoAlertDialog(
//       title: const Text("Camera & microphone permission"),
//       content: const Text("camera & microphone permission should be granted to connect with device, would you like to go to app settings to give Camera & microphone permissions?"),
//       actions: <Widget>[
//         TextButton(
